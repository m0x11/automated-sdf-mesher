// Modified STL Writer that saves to filesystem instead of browser download

var fs = require("fs");
var path = require("path");

var FileSTLWriter = function(outputDir) {
    this.outputDir = outputDir || '../meshes';
}

FileSTLWriter.prototype = {
    ...
    save: function(faces, len, filename) {
        ...
        var outputPath = path.resolve(__dirname, this.outputDir);
        ...
        console.log(`STL saved: ${filePath}`);
        return filePath;
    }
};

module.exports = FileSTLWriter;